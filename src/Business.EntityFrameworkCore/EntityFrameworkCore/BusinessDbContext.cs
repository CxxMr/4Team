...
namespace Business.EntityFrameworkCore
{
        ...
        ITenantManagementDbContext
    {
        ...
        public DbSet<MyRoleModel> MyRoleModel { get; set; }
        public DbSet<MyPowerModel> MyPowerModel { get; set; }
        public DbSet<MyUserRoleModel> MyUserRoleModel { get; set; }
        public DbSet<MyPowerRoleModel> MyPowerRoleModel { get; set; }
        public DbSet<MyTreeModel> MyTreeModel { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<MyUserModel>(x => x.ToTable("tb _UserModel"));
            builder.Entity<MyRoleModel>(x => x.ToTable("tb _RoleModel"));
            builder.Entity<MyPowerModel>(x => x.ToTable("tb _PowerModel"));
            builder.Entity<MyUserRoleModel>(x => x.ToTable("tb _UserRoleModel"));
            builder.Entity<MyPowerRoleModel>(x => x.ToTable("tb _PowerRoleModel"));
            builder.Entity<MyTreeModel>(x => x.ToTable("tb _TreeModel"));
